...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/536.99/536.99-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '846666925b1be4659977d4aad2b00da4f07a028dbeea061b8965620389e374c4'
