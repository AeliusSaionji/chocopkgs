...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/565.90/565.90-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'd949951140f09fdf107c7f9f0c1b2a6cf5ebcbf9d817e9407992a3d3ee6b1d6b'
