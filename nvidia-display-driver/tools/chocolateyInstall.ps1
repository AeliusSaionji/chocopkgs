...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/531.18/531.18-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'eaf8638a1d8e17622fce701c03a5e88abd0c602977468af012e34addab9db741'
