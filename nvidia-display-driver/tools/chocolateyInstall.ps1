...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/595.79/595.79-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'eeef0a62bed0afaa5c08b31dcfd666166986bafe7aa27a89f2cecf113363602a'
