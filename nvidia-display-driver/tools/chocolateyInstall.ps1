...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/595.97/595.97-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '979ed00fea181c786f608967377d6d83ac82e6368275994a4182ec79d97b3122'
