...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/572.83/572.83-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '30422fcc4eac0703bddb7c94fe73f71107114eb461d286b65ada2d92440ad2bf'
