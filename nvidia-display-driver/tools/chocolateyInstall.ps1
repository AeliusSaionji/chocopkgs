...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/528.02/528.02-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '0d730ba6f058d35890e08c317f2921575a554226557777f651735f4f786c77eb'
