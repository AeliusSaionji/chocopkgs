...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/526.98/526.98-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '4569099bab40a06bcf28513a6955c970163c0f69a35c3c318482e5180c19db66'
