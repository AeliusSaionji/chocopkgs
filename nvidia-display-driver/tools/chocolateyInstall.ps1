...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/610.62/610.62-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = 'dfe395bbc971825cf30884bc49990a7527b9da72f8df947fb9f196265712d5a5'
