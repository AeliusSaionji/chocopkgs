...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/560.70/560.70-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '276af33f38642978035db087e1690f71d99a8ea79c8b53f7ac92f0cbe5c368cb'
