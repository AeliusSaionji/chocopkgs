...
$packageArgs = @{
  ...
  url64          = 'https://us.download.nvidia.com/Windows/536.67/536.67-desktop-win10-win11-64bit-international-dch-whql.exe'
  checksum64     = '83bcec1a275c768f18a2effc065fa42878fc0ab48a4ad97bd051e4752e7aedb6'
