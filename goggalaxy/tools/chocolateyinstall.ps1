...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url           = 'https://content-system.gog.com/open_link/download?path=/open/galaxy/client/2.0.48.63/setup_galaxy_2.0.48.63.exe'
  softwareName  = 'GOG Galaxy*'
  checksum      = '54c942f006ca347aa2d1b46a205248c9'
  checksumType  = 'md5'
