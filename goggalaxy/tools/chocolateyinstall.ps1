...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url           = 'https://content-system.gog.com/open_link/download?path=/open/galaxy/client/2.0.49.1/setup_galaxy_2.0.49.1.exe'
  softwareName  = 'GOG Galaxy*'
  checksum      = '7d74ada468fb29d618a356d932ffb924'
  checksumType  = 'md5'
