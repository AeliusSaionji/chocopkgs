...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url           = 'https://content-system.gog.com/open_link/download?path=/open/galaxy/client/2.0.61.63/setup_galaxy_2.0.61.63.exe'
  softwareName  = 'GOG Galaxy*'
  checksum      = '2ea8a4c1d36927a5f246aab4edf59b67'
  checksumType  = 'md5'
