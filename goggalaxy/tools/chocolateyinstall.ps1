...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url           = 'https://content-system.gog.com/open_link/download?path=/open/galaxy/client/2.0.37.384/setup_galaxy_2.0.37.384.exe'
  softwareName  = 'GOG Galaxy*'
  checksum      = 'f74bf8b75e885580b2e45cbb5fa1dede'
  checksumType  = 'md5'
