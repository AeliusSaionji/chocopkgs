...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url           = 'https://content-system.gog.com/open_link/download?path=/open/galaxy/client/2.0.53.121/setup_galaxy_2.0.53.121.exe'
  softwareName  = 'GOG Galaxy*'
  checksum      = '966bfe7acee3eb693bf9ff56622c5ec8'
  checksumType  = 'md5'
