...
If ( [System.Environment]::OSVersion.Version.Major -eq '10' ) {
	$url   = "https://us.download.nvidia.com/Windows/{{PackageVersion}}/{{PackageVersion}}-desktop-win10-32bit-international-whql.exe"
	$url64 = "https://us.download.nvidia.com/Windows/{{PackageVersion}}/{{PackageVersion}}-desktop-win10-64bit-international-whql.exe"
	...
	$url   = "https://us.download.nvidia.com/Windows/$version/$version-desktop-win8-win7-32bit-international-whql.exe"
	$url64 = "https://us.download.nvidia.com/Windows/$version/$version-desktop-win8-win7-64bit-international-whql.exe"
...
Install-ChocolateyPackage $packageName $fileType $silentArgs $url $url64 -Checksum $checksum -ChecksumType $checksumType -Checksum64 $checksum64
