...
$url = 'https://github.com/Nandaka/PixivUtil2/releases/download/v20201130/pixivutil20201130.zip'
$checksum = 'f5a65f6e3fc4bf23e79c2d0ef10aaf94b5fdadaaf32b9c0f0b074a3e9bbe2bfd'
$checksumType = 'sha256'
