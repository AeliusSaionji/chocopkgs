...
$url = 'https://github.com/Nandaka/PixivUtil2/releases/download/v20190917/pixivutil20190919.zip'
$checksum = 'a4f2aa8252ee4a1b4b1e83021bcebe5378923e7e791a360b835f5894785f8e6b'
$checksumType = 'sha256'
