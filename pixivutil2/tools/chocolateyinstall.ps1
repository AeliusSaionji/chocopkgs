...
$url = 'https://github.com/Nandaka/PixivUtil2/releases/download/v20191116/pixivutil20191116.zip'
$checksum = '496a676908c9d6c444e1e91a18b64757bf806247db7b4808dfc4a80439ee3521'
$checksumType = 'sha256'
