...
$url = 'https://github.com/Nandaka/PixivUtil2/releases/download/v20200915/pixivutil20200915.zip'
$checksum = '449dce055c812e8daa8fd98094b6749fe35d164d62ad4005026902c394629fb3'
$checksumType = 'sha256'
